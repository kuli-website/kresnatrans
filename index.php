...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="mainNavbar">
        <div class="container">
            ...
            <h2>PT KRESNA UTAMA TRANS WISATA</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <div class="hero-image-wrapper">
                        <?php echo getMediaImage('hero_image', 'img/logobg.png', 'Sewa Bus Jogja - Armada Bus Premium untuk Rental Bus Yogyakarta', 'img-fluid hero-image', ['loading' => 'eager', 'width' => '600', 'height' => '400']); ?>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about-features">
                        <div class="feature-box">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Semua armada kami terjamin keamanannya dengan perawatan berkala dan asuransi lengkap.</p>
                            </div>
                        </div>
                        <div class="feature-box">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Driver berpengalaman dan memiliki sertifikat resmi untuk memastikan perjalanan Anda nyaman.</p>
                            </div>
                        </div>
                        <div class="feature-box">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                <h4>Layanan 24/7</h4>
                                <p>Kami siap melayani Anda kapan saja, termasuk di hari libur untuk kebutuhan mendesak.</p>
                            </div>
                        </div>
                        <div class="feature-box">
                            <div class="feature-icon">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Paket harga transparan tanpa biaya tersembunyi, memberikan nilai terbaik untuk uang Anda.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Armada Section -->
    <section id="armada" class="armada-section py-5">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
                    <div class="package-card">
                        <div class="package-header">
                            ...
                            <p class="package-period">Mulai dari / 12 Jam</p>
                        </div>
                        <div class="package-body">
                            <ul class="package-features">
                                <li><i class="fas fa-check"></i> Durasi 12 jam</li>
                                <li><i class="fas fa-check"></i> Driver profesional</li>
                                <li><i class="fas fa-check"></i> BBM termasuk</li>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="package-card package-featured">
                        ...
                        <div class="package-header">
                            ...
                            <p class="package-period">Mulai dari / 24 Jam</p>
                        </div>
                        <div class="package-body">
                            <ul class="package-features">
                                <li><i class="fas fa-check"></i> Durasi 24 jam</li>
                                <li><i class="fas fa-check"></i> Driver profesional</li>
                                <li><i class="fas fa-check"></i> BBM termasuk</li>
                                <li><i class="fas fa-check"></i> Air mineral</li>
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="package-card">
                        <div class="package-header">
                            <h3>Paket Drop Off</h3>
                            <div class="package-price">
                                <span class="price-currency">Rp</span>
                                <span class="price-amount">1.500.000</span>
                            </div>
                            <p class="package-period">One Way Trip</p>
                        </div>
                        <div class="package-body">
                            <ul class="package-features">
                                <li><i class="fas fa-check"></i> Perjalanan satu arah</li>
                                <li><i class="fas fa-check"></i> Driver profesional</li>
                                <li><i class="fas fa-check"></i> BBM termasuk</li>
                                <li><i class="fas fa-check"></i> Air mineral</li>
                                <li><i class="fas fa-check"></i> Parkir & tol</li>
    ...
    <section id="contact" class="contact-section py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="contact-card">
                        <h4 class="contact-card-title">Informasi Kontak</h4>
                        <div class="contact-info">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    <h5>Email</h5>
                                    <a href="mailto:info@sewabusjogja.com">info@sewabusjogja.com</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            <li><a href="#packages">Paket City Tour</a></li>
                            <li><a href="#packages">Paket Wisata</a></li>
                            <li><a href="#packages">Paket Drop Off</a></li>
                            <li><a href="#armada">Sewa Big Bus</a></li>
                            <li><a href="#armada">Sewa Medium Bus</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="footer-contact mt-3">
                            ...
                            <a href="tel:+628123456789" class="footer-phone">+62 812-3456-789</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="footer-copyright">&copy; <?php echo date('Y'); ?> Sewa Bus Jogja. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
